...
<div class="grid grid-cols-1 lg:grid-cols-3 p-4">
    ...
    <div class="text-center lg:text-end">
        <button wire:click="$set('modal' ,true)" type="button" class="text-[#0e1726] bg-white hover:bg-[#0e1726] border-2 border-[#0e1726] hover:text-white rounded-lg text-sm py-1 px-3  mr-2">
            {{ $boton_name}}
          </button>
    </div>
</div>