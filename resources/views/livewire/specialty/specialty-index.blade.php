<div>
                                ...
                                @foreach ($specialties as $item)   
                                    <tr class=" border-b  hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 flex ">
                                            ...
                                            <a  class=" p-1 text-base font-normal  text-black hover:bg-red-500 hover:text-white  rounded-lg  cursor-pointer " wire:click="$emit('deleteSpecialty',{{$item->id}})">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <x-modal-form :head='$componentName' :id='$selected_id'>
        @include('livewire.specialty.specialty-form')
    </x-modal-form>
...
<script>
    Livewire.on('deleteSpecialty',specialtytId=>{
      Swal.fire({
              ...
              if (result.value) {
                  Livewire.emitTo('specialty.specialty-index','delete',specialtytId);
                  Swal.fire(
                  'Eliminado!',
