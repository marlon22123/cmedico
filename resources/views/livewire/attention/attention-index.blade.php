<div>
                                ...
                                @foreach ($attentions as $item)   
                                    <tr class=" border-b  hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 flex  ">
                                            ...
                                            @if ($item->service->count()<1 and $item->user->count()<1 and $item->patient->count()<1 )
                                            <a  class=" p-1 text-base font-normal  text-black hover:bg-red-500 hover:text-white  rounded-lg  cursor-pointer " wire:click="$emit('deleteAttention',{{$item->id}})">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <x-modal-form :head='$componentName' :id='$selected_id'>
        @include('livewire.attention.attention-form')
    </x-modal-form>
...
<script>
    Livewire.on('deleteAttention',attentiontId=>{
      Swal.fire({
              ...
              if (result.value) {
                  Livewire.emitTo('attention.attention-index','delete',attentiontId);
                  Swal.fire(
                  'Eliminado!',
