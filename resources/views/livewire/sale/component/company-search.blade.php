                ...
                <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                                ...
                                <div class="flex items-center">   
                                    <input type="text" class="w-20  rounded-md block bg-gray-200 border-gray-300 shadow-sm py-2 mt-1 mr-2 pl-5 pr-7 text-gray-500  sm:text-sm" disabled value="RUC">                                  
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <label  for="names" class="block text-sm font-medium text-gray-700">Nombre / Razon Social</label>
                            ...
                            <div class="col-span-6 sm:col-span-3 lg:col-span-1">
                                <label for="place" class="block text-sm font-medium text-gray-700">Estado</label>
                                <input  wire:model.defer="status" type="text"  id="place" autocomplete="postal-code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" >
                                @error('status')
                                <h1 class="text-red-500">{{$message}}</h1>
                                @enderror
                            </div>
                        <div class="col-span-6 sm:col-span-6 lg:col-span-1">
                            <label for="phone" class="block text-sm font-medium text-gray-700">Condicion</label>
                            <input  wire:model.defer="condition" type="text"  id="phone" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            @error('condition')
                            <h1 class="text-red-500">{{$message}}</h1>
                            @enderror
                        </div>
