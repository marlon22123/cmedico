<div>
   <button wire:click="$set('modal',true)"   class="p-2 mt-1 ml-2 text-sm font-medium text-white bg-blue-700  border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
            ...
            <div class="grid grid-cols-6 gap-6">
                  <div class="col-span-6">
                           ...
                           <div class="flex items-center">   
                              <select  wire:model.defer="type_document" id="currency" name="currency" class="h-full rounded-md block border-gray-300 shadow-sm py-2 mt-1 mr-2 pl-2 pr-7 text-gray-500 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                     ...
                     <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                           ...
                           <input  wire:model.defer="place" type="text"  id="place" autocomplete="postal-code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" >
                           @error('place')
                           <h1 class="text-red-500">{{$message}}</h1>
                           @enderror
                     </div>
                     <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                        ...
                        <input  wire:model.defer="phone" type="text"  id="phone" autocomplete="address-level2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        @error('phone')
                        <h1 class="text-red-500">{{$message}}</h1>
                        @enderror
                     </div>
                     ...
                     <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                        <label for="birth" class="block text-sm font-medium text-gray-700">Fecha Nacimiento</label>
                        <input  wire:model.defer="birth" type="date"  id="birth" autocomplete="address-level1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        @error('birth')
                        <h1 class="text-red-500">{{$message}}</h1>
                        @enderror
                     </div>
